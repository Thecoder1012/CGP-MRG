...
# Load BARTScore
bart_scorer = BartForConditionalGeneration.from_pretrained('facebook/bart-large-cnn', cache_dir = "/LLM/BART/").to("cuda:0")
bart_tokenizer = BartTokenizer.from_pretrained('facebook/bart-large-cnn', cache_dir = "/LLM/BART/")
